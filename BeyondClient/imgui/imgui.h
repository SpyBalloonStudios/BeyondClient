...
namespace ImGui
{
    ...
    void GlowText(float size, const char* label, ImVec2 pos, ImU32 text_color, float glow_size);
    ...
    void CustomSliderInt(const char* label, int* v, int v_min, int v_max, float Rounding);
    void CustomSliderFloat(const char* label, float* v, float v_min, float v_max, float Rounding);
