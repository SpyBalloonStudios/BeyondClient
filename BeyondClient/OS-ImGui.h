...
namespace OSImGui
{
	...
	public:
		...
		void GlowingBox(Vec2 Pos, Vec2 Size, ImColor Color, float Thickness, float Rounding, float GlowIntensity);
		...
		void move_circles();
		void Draw_Particles(ImU32 color);
		void Setup_Particles(int AmountofCircles);
		// 圆弧
