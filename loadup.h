...
namespace driver
{
	namespace util
	{
		...
		{
			HKEY reg_handle;
			static const std::string reg_key(XorStr("System\\CurrentControlSet\\Services\\"));
		...
		{
			HKEY reg_handle;
			std::string reg_key(XorStr("System\\CurrentControlSet\\Services\\"));
	...
	__forceinline auto load(const std::string& drv_path, const std::string& service_name) -> bool
	{
		...
		std::string reg_path(XorStr("\\Registry\\Machine\\System\\CurrentControlSet\\Services\\"));
